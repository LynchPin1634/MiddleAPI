...
class GradioClient:
    ...
    def inference(language,text):
        ...
        reference_audio_url = cm.get_value("reference")["reference_audio_url"]
        if reference_audio_url == "":
            reference_audio = cm.get_value("reference")["reference_audio_local"]
        else:
            reference_audio = cm.get_value("reference")["reference_audio_url"]
        ...
        inference_text_language = cm.get_value("inference")["inference_text_language"]

        radio_component = OldAPI.old_api(use_new_api,cm.get_value("cutting")["cutting_mode"])
